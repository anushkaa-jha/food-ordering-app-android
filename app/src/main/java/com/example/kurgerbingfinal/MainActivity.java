...
/*
 * MainActivity created by Matthew Cline
 *      I'll let you two figure out what/if you want anything said for claiming
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnViewCart.setOnClickListener(view -> startActivity(new Intent(MainActivity.this, ViewCart.class)));
